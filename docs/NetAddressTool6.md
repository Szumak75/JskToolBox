...
## Public Classes
1. [Word16](https://github.com/Szumak75/JskToolBox/blob/1.0.14/docs/NetAddressTool6.md#word16)(**value**: Union[str, int, Word16])
1. [Address6](https://github.com/Szumak75/JskToolBox/blob/1.0.14/docs/NetAddressTool6.md#address6)(**addr**: Union[str, int, Union[List[int], List[str], List[Word16]]])
1. [Prefix6](https://github.com/Szumak75/JskToolBox/blob/1.0.14/docs/NetAddressTool6.md#prefix6)(**addr**: Union[str, int, Union[List[int], List[str], List[Word16]]])
1. [Network6](https://github.com/Szumak75/JskToolBox/blob/1.0.14/docs/NetAddressTool6.md#network6)(**addr**: Union[str, List])
1. [SubNetwork6](https://github.com/Szumak75/JskToolBox/blob/1.0.14/docs/NetAddressTool6.md#subnetwork6)(**network**: Network6, **prefix**: Prefix6)

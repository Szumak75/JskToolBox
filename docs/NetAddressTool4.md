...
1. [Octet](https://github.com/Szumak75/JskToolBox/blob/1.0.17/docs/NetAddressTool4.md#octet)(**value**: Union[str, int, Octet])
1. [Address](https://github.com/Szumak75/JskToolBox/blob/1.0.17/docs/NetAddressTool4.md#address)(**addr**: Union[str, int, Union[List[str], List[int], List[Octet]]])
1. [Netmask](https://github.com/Szumak75/JskToolBox/blob/1.0.17/docs/NetAddressTool4.md#netmask)(**addr**: Union[str, int, Union[List[str], List[int], List[Octet]]])
1. [Network](https://github.com/Szumak75/JskToolBox/blob/1.0.17/docs/NetAddressTool4.md#network)(**addr**: Union[str, List])
1. [SubNetwork](https://github.com/Szumak75/JskToolBox/blob/1.0.17/docs/NetAddressTool4.md#subnetwork)(**network**: Network, **mask**: Netmask)

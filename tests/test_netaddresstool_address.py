...
class TestAddress(unittest.TestCase):
    ...
    def test_02_address_octets(self) -> None:
        """Test nr 2."""
    ...
    def test_04_set_from_list_of_strings(self) -> None:
        """Test nr 4."""
        self.o.octets = ["192", "168", "7", "19"]
        self.assertEqual(str(self.o), "192.168.7.19")

    def test_05_set_from_list_of_octets(self) -> None:
        """Test nr 5."""
    ...
    def test_07_set_from_str(self) -> None:
        """Test nr 7."""
    ...
    def test_14_invalid_address(self) -> None:
        """Test nr 14."""

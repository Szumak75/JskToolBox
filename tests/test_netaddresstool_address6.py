...
class TestAddress6(unittest.TestCase):
    ...
    def test_02_address_words(self):
        """Test nr 2."""
    ...
    def test_04_set_from_list_of_string(self):
        """Test nr 4."""
        self.o.words = ["1", "2", "3", "4", "5", "6", "7", "8"]
        self.assertEqual(str(self.o), "1:2:3:4:5:6:7:8")

    def test_05_set_from_list_of_words(self):
        """Test nr 5."""
        self.o.words = [
            Word16("0xFF"),
            Word16("0"),
    ...
    def test_07_set_from_string(self):
        """Test nr 7."""
    ...
    def test_14_adress_invalid(self):
        """Test nr 14."""

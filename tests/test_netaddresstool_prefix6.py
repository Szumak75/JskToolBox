...
class TestPrefix6(unittest.TestCase):
    ...
    def test_01_create_from_int(self):
        """Test nr 1."""
        try:
            Prefix6(128)
        except Exception:
    ...
    def test_02_create_from_str(self):
        """Test nr 2."""
        try:
            Prefix6("128")
        except Exception:
    ...
    def test_05_create_invalid_prefix(self):
        """Test nr 5."""
    ...
    def test_06_create_valid_prefix(self):
        """Test nr 6."""
        try:
